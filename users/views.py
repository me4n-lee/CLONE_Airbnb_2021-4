...
def github_login(request):
    ...
    redirect_uri = "http://airbnb.eba-vma4eyci.ap-northeast-2.elasticbeanstalk.com/users/login/github/callback"
    return redirect(
...
def kakao_login(request):
    ...
    redirect_uri = "http://airbnb.eba-vma4eyci.ap-northeast-2.elasticbeanstalk.com/users/login/kakao/callback"
    return redirect(
